        ...
        regi.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/exp10?characterEncoding=latin1", "root", "shravani");

                    String query = "INSERT INTO Registration(firstName,lastName,userName,password,emailId,mobileNumber) values('" + firstName + "','" + lastName + "','" + userName + "','" +
